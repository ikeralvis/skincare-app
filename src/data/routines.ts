...
export const dailyRoutine = [
  {
    step: 1,
    title: "Módulo de Limpieza Profunda: Purificador de Superficie",
  ...
  {
    step: 2,
    title: "Módulo de Refuerzo Celular: Suero Hidratante Concentrado",
  ...
  {
    step: 3,
    title: "Módulo de Sellado y Confort: Emulsión de Equilibrio Dérmico",
  ...
  {
    step: 4,
    title: "Módulo de Defensa Activa: Escudo Solar Fotoprotector Ultraligero",
...
export const nightlyRoutineWithLactic = [
  ...
  {
    step: 2,
    title: "Módulo de Regeneración Nocturna: Regenerador Superficial Bio-Activo",
